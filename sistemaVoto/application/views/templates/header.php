...
<head>
    ...
    @media screen and (max-width: 600px) {
        .panel-body, .container, .table-responsive, .form-group, #tabela_reuniao {
        ...
        table, .table-bordered, .table-striped, #tabela_reuniao {
            width: 100%;
        }
        ...
        #tabela_reuniao td:nth-of-type(1):before { content: "ID"; font-weight: bold; }
        #tabela_reuniao td:nth-of-type(2):before { content: "INÍCIO"; font-weight: bold;}
        #tabela_reuniao td:nth-of-type(3):before { content: "LIMITE"; font-weight: bold;}
        #tabela_reuniao td:nth-of-type(4):before { content: "TIPO"; font-weight: bold; }
        #tabela_reuniao td:nth-of-type(5):before { content: "COMISSÃO"; font-weight: bold;}
        #tabela_reuniao td:nth-of-type(6):before { content: "MODERADOR"; font-weight: bold;}
        #tabela_reuniao td:nth-of-type(7):before { content: "SALA"; font-weight: bold;}
